export const timeline = [
  {
    ...
    responsibilities: [
      ...
      "Built a mobile application for efficient shipment data entry on container truck deliveries",
      "Designed and implemented a web-based inventory monitoring system to track incoming, outgoing, and scrapped items",
      "Introduced a multi-level approval feature to enhance inventory control and transparency"
    ],
  },
  // {
  //   company: "Google",
